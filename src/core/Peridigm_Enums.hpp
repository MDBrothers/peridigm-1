...
enum Boundary_Condition_Type
{
  ...
  INITIAL_FRAC_PRESSURE,
  INITIAL_PHASE_1_SAT_PORES,
  INITIAL_PHASE_1_SAT_FRAC,
  PRESCRIBED_PORE_PRESSURE,
  PRESCRIBED_FRAC_PRESSURE,
  PRESCRIBED_PHASE_1_SAT_PORES,
  PRESCRIBED_PHASE_1_SAT_FRAC,
